...
function M.setup(opts)
  ...
  local colors = require("kaolin.colors").setup(opts)
  local groups = require("kaolin.groups").setup(colors, opts)
  ...
  vim.g.colors_name = "kaolin-" .. opts.style
...
function M.terminal(colors)
  ...
  vim.g.terminal_color_18 = Util.blend_fg(colors.yellow, 0.5)
