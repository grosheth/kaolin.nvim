...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("kaolin.hsluv")
    if color ~= "NONE" then
...
---@param groups kaolin.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/kaolin-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, kaolin.Cache
